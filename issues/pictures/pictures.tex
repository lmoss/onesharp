...
\path [->, thick] (circ2)  edge  (circ3);


\path [->, thick] (circ4)  edge  (circ2);

\path [->, thick] (circ4)  edge  (circ6);

\path [->, thick] (circ4)  edge  (circ7);



\path [->, thick] (circ4)  edge  (circ9);

\path [->, thick] (circ3)  edge  (circ8);

\path [->, thick] (circ4)  edge  (circ8);

\path [->, thick] (circ4)  edge  (circ11);

\path [->, thick] (circ11)  edge  (circ10);

\path [->, thick] (circ6)  edge  (circ2);

\path [->, thick] (circ8)  edge  (circ7);

\path [->, thick] (circ10)  edge  (circ6);

\path [->, thick] (circ10)  edge  (circ1);

\path [->, thick] (circ9)  edge  (circ2);


\path [->, thick] (circ9)  edge  (circ10);


\path [->, thick] (circ7)  edge  (circ5);
