...
%%%
%
 \draw  (1,1.5) node{$a\, \blacksquare$};  %% north
\draw  (1,.5) node{$\blacksquare\, a\, \blacksquare\, b$};  %% south
\draw  (3.5,1.5) node{$b\, \blacksquare\,  a\, \blacksquare\, a\, \blacksquare$};  %% north
\draw  (3.5,.5) node{$\blacksquare\, a\, \blacksquare\, a\, \blacksquare\, b$};  %% south
 \draw  (6,1.5) node{$\blacksquare\, a\, \blacksquare\, $};  %% north
\draw  (6,.5) node{$\blacksquare\, a\, \blacksquare\, b\, \blacksquare$};  %% south
\draw  (8.5,1.5) node{\$};  %% north
\draw  (8.5,.5) node{$\blacksquare\, \$ $};  %% southf
\end{tikzpicture}
\end{array}$ 
 \end{flushleft}
