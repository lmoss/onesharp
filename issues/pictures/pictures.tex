 ...
 % pdftocairo  -x 50  -y 50  -H 110 -f 5 -l 5 -png pictures.pdf   % single row of tiles
  % pdftocairo  -x 50 -y 50  -H 140 -f 6 -l 6 -png pictures.pdf  % PCP instance
 %  pdftocairo  -x 50 -y 50  -H 140 -f 7 -l 7 -png pictures.pdf 
  
 %  pdftocairo  -x 50 -y 50  -H 140 -f 7 -l 7 -png pictures.pdf trial
 %% this gives a file called   	trial-07.png
 
 %pdftocairo  -x 50 -y 50  -H 140 -f 10 -l 10 -png pictures.pdf 
 %pdftocairo  -x 50 -y 50  -H 140 -f 11 -l 11 -png pictures.pdf 
  %pdftocairo  -x 50 -y 50  -H 140 -f 12 -l 12 -png pictures.pdf 
   %pdftocairo  -x 50 -y 50  -H 140 -f 13 -l 13 -png pictures.pdf 
   %pdftocairo  -x 50 -y 50  -H 140 -f 13 -l 13 -png pictures.pdf 
   
%   pdftocairo  -x 50 -y 50  -H 640 -f 16 -l 16 -png pictures.pdf
        
%   pdftocairo  -x 50 -y 50  -H 640 -f 21 -l 21 -png pictures.pdf
  
 %% pdftocairo  -x 50 -y 50  -H 680 -f 54 -l 54 -png pictures.pdf pictures 
 %% above is the big graph with 11 nodes but going counterclockwise
 
  % pdftocairo  -x 50 -y 50  -H 580 -f 55 -l 55 -png pictures.pdf 
  
%  pdftocairo  -x 50 -y 50  -H 570 -f 56 -l 56 -png pictures.pdf 
  
 %% pdftocairo  -x 50 -y 50  -H 680 -f 57 -l 57 -png pictures.pdf pictures 
 %% above is the big graph with 11 nodes  
 
  % pdftocairo  -x 50 -y 50  -H 140 -f 58 -l 58 -png pictures.pdf  % MPCP instance 
    % pdftocairo  -x 50 -y 50  -H 140 -f 59 -l 59 -png pictures.pdf  %  PCP instance obtained by adding squares and $
...
\draw  (11,1.5) node{ab};  %% north
\draw  (11,.5) node{ba};  %% south
\draw  (13,1.5) node{ab};  %% north
\draw  (13,.5) node{ba};  %% south


\draw  (15.5,1.5) node{aa};  %% north
\draw  (15.5,.5) node{a};  %% south
 \end{tikzpicture}
\end{array}$ 
\end{flushleft}
...
% \draw [thick] (circ1) to (circ2) to (circ3)  to (circ4) to (circ5) to (circ6) to (circ7)to (circ8) to (circ1)to (circ3) to (circ5) to (circ7) to (circ1) to (circ4) to(circ7) to(circ2) to (circ5) to(circ8) to (circ3) to (circ6);


	
%\draw [->] edge (circ1) (circ5);
...
\draw (2) circle  (3.5);
\draw[color=red]  (1) circle (2.5);
%\draw (O) circle (1.5);

\node at (0,3.75) {\small Not-even-in-principle};
\node at (0,3.25) {\small Computable};


\node at (0,2.25) {\small In Principle};
\node at (0,1.75) {\small Computable};

\node at (0,0.35) {\small In Practice};
\node at (0, -.15) {\small Computable};
\node at (0,-.55) {\small As of Now};
\end{tikzpicture}
\end{flushleft}
...
%%%
%
 \draw  (1,1.5) node{$a\, \redsquare$};  %% north
\draw  (1,.5) node{$\redsquare\, a\, \redsquare\, b$};  %% south
\draw  (3.5,1.5) node{$b\, \redsquare\,  a\, \redsquare\, a\, \redsquare$};  %% north
\draw  (3.5,.5) node{$\redsquare\, a\, \redsquare\, a\, \redsquare\, b$};  %% south
 \draw  (6,1.5) node{$\redsquare\, a\, \redsquare\, \bluequestionmark$};  %% north
\draw  (6,.5) node{$\redsquare\, a\, \redsquare\, b\, \bluequestionmark$};  %% south
\draw  (8.5,1.5) node{$\bluequestionmark$};  %% north
\draw  (8.5,.5) node{$\redsquare\, \bluequestionmark$ };  %% southf
\end{tikzpicture}
\end{array}$ 
 \end{flushleft}
