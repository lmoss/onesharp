...
# ````{prf:theorem} Goofier
# :label: goofier-theorem
# 
# Let's prove a theorem using {prf:ref}`goofy-theorem`
# ````
...
# $$
# \begin{tikzpicture}
#     \node at (3,-1.3) {all programs};
# 
#     \draw  (-4.5,-1.5)  rectangle (4.5,1.5);
# 
#     \draw[fill=blue!70,fill opacity=0.2] (0,0) ellipse (2.2cm and 1cm);
#         \draw[fill=red!70,fill opacity=0.5] (0,0) ellipse (1.2cm and .5cm);
#         \node at (-1.6,-.2) {$A$};
#                 \node at (0,0) {$B$};
# \end{tikzpicture}
# $$
